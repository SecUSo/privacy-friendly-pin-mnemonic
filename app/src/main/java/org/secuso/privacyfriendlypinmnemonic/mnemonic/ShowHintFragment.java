...
public class ShowHintFragment extends Fragment {
    ...
    public void clickPractiseButton() {
        ...
        fragmentTransaction.replace(R.id.main_content, practiseFragment, "PractiseFragment");
    ...
    private void doFirstRun() {
        ...
        if (settings.getBoolean("isFirstRun", true)) {
            MnemonicsDialog mnemonicsDialog = new MnemonicsDialog();
            mnemonicsDialog.show(getFragmentManager(), "MnemonicsDialog");
